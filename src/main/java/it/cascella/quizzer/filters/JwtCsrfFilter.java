...
public final class JwtCsrfFilter extends OncePerRequestFilter {
     ...
     * </pre>
     */
    private static final String SHOULD_NOT_FILTER = "SHOULD_NOT_FILTER" + JwtCsrfFilter.class.getName();
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (request.getRequestURI().equals("/api/v1/jwt/login") ||request.getAttribute("skipCSRF") != null && (Boolean.TRUE.equals(request.getAttribute("skipCSRF")))) {
            if (this.logger.isTraceEnabled()) {
                this.logger.trace("Did not protect against CSRF since request was marked to skip CSRF processing");
            }
